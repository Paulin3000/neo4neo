...
class Navbar {
    constructor() {
        ...
        this.navbarExtended = document.getElementById('navbar-extended');
    ...
    toggleDropdown() {
        const isOpen = this.navbar?.classList.contains('expanded') || 
                      this.dropdownItem?.getAttribute('aria-expanded') === 'true';
    ...
    openDropdown() {
        ...
        this.dropdownItem?.classList.add('open');
